    ...
    if (capsule.media_type === 'audio' && capsule.media_url) {
      mediaSection = `
        <div style="background: #f0fdf4; border: 2px solid #22c55e; border-radius: 12px; padding: 20px; margin: 20px 0; text-align: center;">
          ...
          <p style="color: #9ca3af; font-size: 12px; margin-top: 12px;">Click the button above to listen. Link is valid for a long time.</p>
        </div>
      `
      ...
      mediaSection = `
        <div style="background: #eff6ff; border: 2px solid #3b82f6; border-radius: 12px; padding: 20px; margin: 20px 0; text-align: center;">
          ...
          <p style="color: #9ca3af; font-size: 12px; margin-top: 12px;">Click the button above to watch. Link is valid for a long time.</p>
        </div>
      `
    }

    // Build text section (only if has text message and not just a placeholder)
